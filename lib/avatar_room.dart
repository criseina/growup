  ...
  AvatarRoom(
    ...
    fixedObjects: [
      RoomObject(
        ...
        name: '식탁',
        kind: RoomObjectKind.fixed,
        position: RoomPoint(83, 80),
        approachPoint: RoomPoint(62, 73),
        interaction: RoomInteraction.eat,
        interactionAnimation: 'eat',
        interactionFacing: RoomFacing.right,
        visualSize: RoomSize(31, 22),
        depth: 80,
        anchor: RoomObjectAnchor.floorBottomCenter,
        relatedActionIds: {'M-01', 'M-02', 'M-03'},
        collision: RoomRect(69, 65, 29, 15),
      ),
      RoomObject(
        id: 'kitchen_cabinet',
        name: '식기장',
        kind: RoomObjectKind.fixed,
        position: RoomPoint(47, 62),
        approachPoint: RoomPoint(47, 70),
        interaction: RoomInteraction.organize,
        interactionAnimation: 'organize_dishes',
        interactionFacing: RoomFacing.left,
        visualSize: RoomSize(25, 21),
        depth: 62,
        anchor: RoomObjectAnchor.floorBottomCenter,
        relatedActionIds: {'M-04'},
        collision: RoomRect(35, 49, 25, 13),
      ),
      RoomObject(
        id: 'kitchen_sink',
        name: '싱크대',
        kind: RoomObjectKind.fixed,
        position: RoomPoint(20, 62),
        ...
        collision: RoomRect(5, 48, 30, 14),
      ),
      RoomObject(
        id: 'kitchen_fridge',
        name: '냉장고',
        kind: RoomObjectKind.fixed,
        position: RoomPoint(68, 62),
        ...
        depth: 62,
        anchor: RoomObjectAnchor.floorBottomCenter,
        collision: RoomRect(58, 43, 20, 19),
      ),
    ],
    slots: [
      DecorationSlot(
  ...
  AvatarRoom(
    ...
    fixedObjects: [
      RoomObject(
        ...
        name: '낮은 선반',
        kind: RoomObjectKind.fixed,
        position: RoomPoint(15, 80),
        approachPoint: RoomPoint(28, 82),
        interaction: RoomInteraction.organize,
        ...
        collision: RoomRect(1, 66, 28, 15),
      ),
      RoomObject(
        id: 'playroom_bookshelf',
        name: '큰 책장',
        kind: RoomObjectKind.fixed,
        position: RoomPoint(87, 80),
        approachPoint: RoomPoint(75, 82),
        interaction: RoomInteraction.organize,
        ...
        collision: RoomRect(76, 62, 23, 19),
      ),
    ],
    slots: [
      DecorationSlot(
